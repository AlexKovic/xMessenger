...
static SettingsManager settings = SettingsManager.getInstance();
	...
	public static HashMap<String, LavaMap> inqueue = new HashMap<String, LavaMap>();
	
	public static boolean playing;
	
	public static boolean open;
	
	public static LavaMap runningmap = null;
	
	public static int players;
	
	public static HashMap<String, LavaMap> maps = new HashMap<String, LavaMap>();
	...
	public static void startTourney(final LavaMap map){
		playing = true;
		open = true;
		runningmap = map;
		EventsHandler.runningevent = "lava";
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				if(maps.size() < 2){
					EventsHandler.runningevent = null;
					runningmap = null;
					players = 0;
					playing = false;
					open = false;
			...
			public void run() {
				for (Player on : Bukkit.getOnlinePlayers()) {
					if (invincible.contains(on.getName()) && maps.get(on.getName()) == map) {
						...
						on.sendMessage(ChatColor.RED + "" + ChatColor.RED + "You are no longer invincible!");
					}
				}
			}
